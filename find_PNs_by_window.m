...
%                 allSN = 13;
            ...
            if sensitivity(uu,highSN,ww) && sensitivity(uu,lowSN,ww) && sensitivity(uu,1,ww) %sensitivity(uu,1,ww) && 
                ...
                if rho>rho_threshold
                    ...
                    PN_unit_list = [PN_unit_list; unit ww];
        
                    if strcmp(plot_yn,'y')
        
                        clf
                        stim_to_plot = stims_to_plot;
